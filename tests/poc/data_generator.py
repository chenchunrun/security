...
class AlertDataGenerator:
    ...
    def _generate_type_fields(self, alert_type: str) -> Dict[str, Any]:
        ...
        if alert_type == "malware":
            ...
            fields.update({
                "anomaly_type": random.choice(["Traffic Spike", "Unusual Time", "New Location"]),
...
def main():
    ...
    parser.add_argument("--output", type=str, default="tests/poc/data/alerts.json", help="Output file path")
